...
if __name__ == "__main__":
    ...
    for data_dir in tqdm(data_dirs):
        data_dir = data_dir[:-1]  # delete last slash
        ...
        data_dir = os.path.join(data_dir, "miru2024")
        ...
        with torch.no_grad():
            pre_n_frame = seq_len
            results_tmp = []
            for batch in tqdm(dataloader, total=n_samples, leave=False, desc=video_num):
        ...
        vis.plot_tsne(
            ...
            labels,
            10,
            f"{data_dir}/pred_mu_tsne_id.jpg",
            cmap="tab10",
            lut=lut,
            legend=False,
        )
